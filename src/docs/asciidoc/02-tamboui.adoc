...
currenty in 0.4.0 or 0.5.0 snapshot as developed as open source
...
We will briefly look below the surface, but mostly look at toolkit level to get a running TUI with ease
--
...
| Reliable default on all platforms 
| Java 8+
...
| Aesh based, for SSH/Browser-hosted terminals 
| Java 8+
...
I tried to use panama where applicable
--
